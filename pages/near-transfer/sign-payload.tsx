...
export default function PageWithJSbasedForm() {
  ...
  const handleNextPage = async () => {
    router.push("/near-transfer/broadcast-transaction")
  }
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    privKey = localStorage.getItem('DEMO_NEAR_SECRET')
      // @ts-ignore
  setFlowId(localStorage.getItem('DEMO_TRANSFER_FLOW'))
    ...
    const response = await fetch("/api/near-transfer/near-sign-payload", {
  ...
  return (
    <div className="container">
      ...
      After submitting the transfer data, provide the unsigned <code>transaction_payload</code> below.<br /><br />
