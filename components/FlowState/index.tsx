    ...
    return (
        <div className="container">
            ...
            <form onSubmit={handleSubmit} method="post">
                <button type="button" disabled={flowState === 'delegated'} onClick={handleGetStatus}>Get the current state of the transaction 🔄</button>
            </form>
            ...
            {flowState ? (
                <>
                    ...
                    {flowState === 'delegated' ? (
                        <>
                            <Link target='_blank' style={{ marginTop: '20px' }} href={`https://explorer.testnet.near.org/accounts/${appState.account}`}>View Transactions on Near Explorer</Link>
