  ...
  return (
    <div className="container">
      ...
      <p className={styles.description}>
        ...
        <b>NEAR</b>, <b>Testnet</b>, <b>{toTitleCase(operation)}</b> and{" "}
      ...
      <form onSubmit={handleSubmit} method="post">
        ...
        <select id="operation" name="operation" required defaultValue="staking">
          <option disabled={operation !== "staking"} value="staking">
            Staking
          </option>
          <option disabled={operation !== "unstaking"} value="unstaking">
            Unstaking
          </option>
          <option disabled={operation !== "transfer"} value="transfer">
            Transfer
          </option>
        </select>
